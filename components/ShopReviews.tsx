...
interface ShopReviewsProps {
  shopId: string;
  onShopDataNeedsRefresh: () => void; // Callback to tell parent (App.tsx) to reload all shops
}

const ShopReviews: React.FC<ShopReviewsProps> = ({ shopId, onShopDataNeedsRefresh }) => {
  ...
  return (
    <div className="mt-5 pt-5 border-t border-pink-200">
      <h4 className="text-lg font-semibold text-gray-800 mb-3">
        <i className="fas fa-comments mr-2 text-pink-500"></i> 방문자 리뷰
      </h4>
      {isLoading && (
